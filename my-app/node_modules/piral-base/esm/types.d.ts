 ...
 */
export declare type PiletMetadataV0 = PiletMetadataV0Content | PiletMetadataV0Link;
/**
 ...
 */
export declare type SinglePiletMetadata = PiletMetadataV0 | PiletMetadataV1 | PiletMetadataVx;
/**
 * The metadata response for a multi pilet.
 */
export declare type MultiPiletMetadata = PiletMetadataBundle;
/**
 * Describes the metadata transported by a pilet.
 */
export declare type PiletMetadata = SinglePiletMetadata | MultiPiletMetadata;
/**
 ...
 */
export declare type SinglePilet = SinglePiletApp & SinglePiletMetadata;
/**
 * An evaluated multi pilet.
 */
export declare type MultiPilet = MultiPiletApp & MultiPiletMetadata;
/**
