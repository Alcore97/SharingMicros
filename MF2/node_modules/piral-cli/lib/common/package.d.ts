...
export declare function copyScaffoldingFiles(source: string, target: string, files: Array<string | TemplateFileLocation>, piralInfo?: any): Promise<void>;
export declare function copyPiralFiles(root: string, name: string, piralInfo: any, forceOverwrite: ForceOverwrite, originalFiles?: Array<FileInfo>): Promise<void>;
...
export declare function patchPiletPackage(root: string, name: string, version: string, piralInfo: any, newInfo?: {
