...
function runPnpmProcess(args, target, output) {
    log_1.log('generalDebug_0003', 'Starting the Pnpm process ...');
    const cwd = path_1.resolve(process.cwd(), target);
    return scripts_1.runCommand('pnpm', args, cwd, output);
}
...
function installDependencies(target = '.', ...flags) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        log_1.log('generalDebug_0003', `Pnpm install dependencies result: ${ms.value}`);
        return ms.value;
    });
}
...
function installPackage(packageRef, target = '.', ...flags) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        log_1.log('generalDebug_0003', `Pnpm install package result: ${ms.value}`);
        return ms.value;
    });
}
