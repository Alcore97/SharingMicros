...
function default_1(context, options = 'ignore') {
    return __awaiter(this, void 0, void 0, function* () {
        if (options !== 'ignore') {
            const { externals } = common_1.getPiletsInfo(context.data.appPackage);
            ...
            const missingExternals = externals
                .map((name) => {
                const valid = common_1.isValidDependency(name);
            ...
            if (options === 'only-used' && missingExternals.length > 0) {
                ...
                const files = yield common_1.getSourceFiles(context.entry);
