...
const providers = {
    ...
    xcopy(files, args) {
        return __awaiter(this, void 0, void 0, function* () {
            const { target } = args;
            if (!target) {
                common_1.fail('publishXcopyMissingTarget_0112');
            }
            yield Promise.all(files.map((file) => __awaiter(this, void 0, void 0, function* () { return common_1.copy(file, path_1.resolve(target, path_1.basename(file))); })));
        });
    },
};
function findReleaseProvider(providerName) {
    ...
    if (typeof provider !== 'function') {
        common_1.fail('publishProviderMissing_0113', providerName, helpers_1.availableReleaseProviders);
    }
    return provider;
}
