...
function runLernaProcess(args, target, output) {
    log_1.log('generalDebug_0003', 'Starting the Lerna process ...');
    const cwd = path_1.resolve(process.cwd(), target);
    return scripts_1.runCommand('lerna', args, cwd, output);
}
function bootstrap(target = '.', ...flags) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        log_1.log('generalDebug_0003', `Lerna bootstrap result: ${ms.value}`);
        return ms.value;
    });
}
