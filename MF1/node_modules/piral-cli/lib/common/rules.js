...
function ruleSummary(errors, warnings) {
    if (errors.length > 0) {
        log_1.fail('validationFailed_0080', errors.length);
    }
    else if (warnings.length > 0) {
        log_1.log('validationWarned_0081', warnings.length);
    }
    else {
        log_1.logDone('Validation successful. No errors or warnings.');
    }
}
...
function runRules(rules, context, configurations = {}) {
    return __awaiter(this, void 0, void 0, function* () {
        for (const rule of rules) {
            log_1.log('generalDebug_0003', `Running rule "${rule === null || rule === void 0 ? void 0 : rule.name}" ...`);
