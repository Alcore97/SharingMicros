...
var PiralInstanceWebpackPlugin = /** @class */ (function () {
    ...
    PiralInstanceWebpackPlugin.prototype.apply = function (compiler) {
        ...
        var variables = __assign(__assign({}, helpers_1.getVariables(name, version, externals, environment)), this.options.variables);
        if (debug) {
        ...
        var plugins = [new webpack_1.DefinePlugin(helpers_1.getDefineVariables(variables))];
